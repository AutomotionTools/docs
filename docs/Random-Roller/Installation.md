...
To manually install Random Roller, place the `Random Roller.jsxbin` file into the 'ScriptUI Panels' folder in your version of After Effects.
...
a support ticket at [aescripts.com](https://aescripts.com/contact/?direct=1&product_id=2668).